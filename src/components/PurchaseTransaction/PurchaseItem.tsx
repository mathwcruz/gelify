    ...
    >
      <div className="mb-2 flex w-full flex-row justify-between gap-[60px]">
        <div className="flex w-full flex-col justify-center">
          <span className="mb-[1px] text-left text-sm">Produto</span>
          <span className="flex flex-row items-center justify-center gap-2 text-left text-sm font-medium text-gray-500">
            ...
            <Link href={`/edit/product/${purchaseItem?.product_id}`}>
              ...
              >
                <ShoppingBagIcon className="h-5 w-5 text-green-400 transition-colors duration-300 ease-linear hover:text-green-600" />
              </a>
            </Link>
          </span>
        </div>
